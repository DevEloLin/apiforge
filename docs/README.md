...
| Doc | What it covers |
|---|---|
| [USAGE.md](./USAGE.md) | Client API: auth, endpoints, model routing, chat/stream/images, admin, SDKs |
| [OPERATIONS.md](./OPERATIONS.md) | Install, configuration, Docker packaging & config, compose, systemd, Raspberry Pi, troubleshooting |
...
| 文档 | 内容 |
|---|---|
| [使用手册 USAGE.zh-CN.md](./USAGE.zh-CN.md) | 客户端调用：认证、端点、模型路由、chat/流式/出图、管理 API、SDK |
| [操作手册 OPERATIONS.zh-CN.md](./OPERATIONS.zh-CN.md) | 安装、配置、Docker 打包与配置、compose、systemd、树莓派、排错 |
